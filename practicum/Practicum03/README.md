...
## Задача 0
Напишете функция, която по подадено име на двоичен файл проверява дали съществува байт, който не участва във файла. Ако да изведете на стандартния изход тези байтове.
